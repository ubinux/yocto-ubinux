...
## 2. Features
### 2.1 Security Fixes
Following security issues have been fixed from ubinux-2023.09.
...
Run as root privilege the Toolchain installer at arbitrary directory, and Toolchain will be installed into /opt/ubinux/2023.10 directory.
...
`$ sudo sh ubinux-glibc-x86_64-meta-toolchain-[TYPE1]-toolchain-2023.10.sh`
...
`$ . /opt/ubinux/2023.10/environment-setup-[TYPE2]`
...
The "usrmerge" feature has been enabled.
Merges the /bin, /sbin, /lib, and /lib64 directories into their respective counterparts in the /usr directory.
If you specify a command or library with an absolute path, you may need to change the path.

#### 4.2.2 psplash

Stuck on the yocto logo screen, unable to enter the system login interface.
Press ALT + left or ALT + right to enter the system login interface.
