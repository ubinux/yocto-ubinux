...
Run as root privilege the Toolchain installer at arbitrary directory, and Toolchain will be installed into /opt/ubinux/2024.08 directory.
...
`$ sudo sh ubinux-glibc-x86_64-meta-toolchain-[TYPE1]-toolchain-2024.08.sh`
...
`$ . /opt/ubinux/2024.08/environment-setup-[TYPE2]`
...
- Screen display (X86_64)
  - Unable to confirm display by screen.
