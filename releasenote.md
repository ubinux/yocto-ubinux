...
## 2. Features
### 2.1 Security Fixes
Following security issues have been fixed from ubinux-2022.06.
...
Run as root privilege the Toolchain installer at arbitrary directory, and Toolchain will be installed into /opt/ubinux/2022.07 directory.
...
`$ sudo sh ubinux-glibc-x86_64-meta-toolchain-[TYPE1]-toolchain-2022.07.sh`
...
`$ . /opt/ubinux/2022.07/environment-setup-[TYPE2]`
...
When using dnf-plugin-tui to install rootfs, the postinstall of some packages failed and the warning information was output:
<pre>
The postinstall intercept hook 'update_udev_hwdb' failed
...
The postinstall intercept hook 'update_gtk_icon_cache' failed
The postinstall intercept hook 'update_gtk_icon_cache' failed
</pre>
